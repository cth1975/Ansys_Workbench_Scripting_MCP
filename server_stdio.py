#!/usr/bin/env python3
"""
Ansys Workbench Scripting MCP Server - STDIO Transport

This version uses the standard stdio transport instead of HTTP/SSE.
...
# Create MCP server instance with stdio settings
mcp = FastMCP(
    "Ansys Workbench Scripting Server (STDIO)",
    debug=True
)
...
if __name__ == "__main__":
    ...
    print("📝 Usage: Connect MCP clients directly to this process", file=sys.stderr)
    print("=" * 70, file=sys.stderr)
    print("", file=sys.stderr)
